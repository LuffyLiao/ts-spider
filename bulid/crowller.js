...
var Crowller = /** @class */ (function () {
    function Crowller(analyzer) {
        ...
        this.filePath = path_1.default.resolve(__dirname, '../data/beauties.json');
        this.init();
    }
    /**
     * 获取html内容
    ...
    Crowller.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            var url, html, fileContent;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = this.analyzer.url;
                        return [4 /*yield*/, this.getRawHtml(url)];
                    case 1:
                        html = _a.sent();
...
var crowller = new Crowller(analyzer);
